...
temporary link to [docs main page 1](..).
temporary link to [docs main page 2](../index).
temporary link to [docs main page 3](../#configure-atlas-programmatic-access).
temporary link to [docs main page 4](../#authenticate-the-provider).
temporary link to [docs main page 5](../index#configure-atlas-programmatic-access).
temporary link to [docs main page 6](../index#authenticate-the-provider).
