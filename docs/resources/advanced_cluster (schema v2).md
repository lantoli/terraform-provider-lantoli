...
This doc is for schema v2 of `mongodbatlas_advanced_cluster`, doc for schema v1 can be found [here](./advanced_cluster). In order to enable this schema, you must set the enviroment variable `MONGODB_ATLAS_ADVANCED_CLUSTER_V2_SCHEMA=true`, othwerwise schema v1 will be used.
